from lib.python_onvif_zeep.onvif.client import ONVIFService, ONVIFCamera, SERVICES
from lib.python_onvif_zeep.onvif.exceptions import ONVIFError, ERR_ONVIF_UNKNOWN, \
